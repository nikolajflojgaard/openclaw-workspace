...
description: "Maintain multiple repos with scanner, audits, CI checks, reports, and safe fixes."
---
...
7. **Report**
   Use `templates/fleet-report.md` and keep reports short and action-oriented.
